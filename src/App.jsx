...
function App() {
  ...
  return (
    <div className="h-screen bg-black text-white flex flex-col items-center justify-between px-6 py-8 md:py-12 overflow-hidden relative">
      ...
      <div className="flex flex-col items-center justify-center flex-grow relative z-10">
        ...
        {/* Tagline */}
        <p className="font-sans text-base md:text-lg text-gray-400 text-center max-w-2xl mb-8 md:mb-10">
          Making the impossible inevitable.
        </p>

        {/* Morph Labs */}
        <div className="max-w-2xl text-center mb-8 md:mb-10">
          <h2 className="font-serif text-2xl md:text-3xl font-semibold mb-3 tracking-tight">
            Building the Future
          </h2>
          <p className="font-sans text-sm md:text-base text-gray-300 mb-3">
            Founder & CTO at{' '}
            <a
          ...
          <p className="font-sans text-sm md:text-base text-gray-400 leading-relaxed max-w-xl mx-auto">
            Pioneering non-invasive brain-computer interfaces. Using EEG headsets to control
            robotic hands naturally, no surgery needed.
          </p>
        </div>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="group inline-flex items-center px-8 py-3 md:px-10 md:py-4 bg-morph hover:bg-morph-hover text-white font-sans font-semibold text-sm md:text-base uppercase tracking-wider transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-morph/50 mb-8"
        >
          Schedule a Call
